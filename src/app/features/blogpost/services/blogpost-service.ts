...
export class BlogpostService {
  ...
  addBlogpost(data: AddBlogPostRequest):Observable<BlogPost> {
    return this.http.post<BlogPost>(`${this.apiUrl}/api/blogpost`, data,{
  ...
  editBlogPost(id:string, body:UpdateBlogPostRequest):Observable<BlogPost>{
    return this.http.put<BlogPost>(`${this.apiUrl}/api/blogpost/${id}`,body,{
      withCredentials:true
    });
  }
  deleteBlogPost(id:string):Observable<BlogPost>{
    return this.http.delete<BlogPost>(`${this.apiUrl}/api/blogpost/${id}`,{
      withCredentials:true
    });
  }
